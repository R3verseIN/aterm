...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    root.style.setProperty("--theme-border", currentThemeColors.brightBlack);
    root.style.setProperty("--theme-accent", currentThemeColors.blue);
  ...
  const themeVars = {
    "--theme-bg": currentThemeColors.background,
    "--theme-bg-secondary": currentThemeColors.background,
    "--theme-fg": currentThemeColors.foreground,
    "--theme-border": currentThemeColors.brightBlack,
    "--theme-accent": currentThemeColors.blue,
    "--theme-selection": currentThemeColors.selectionBackground,
    backgroundColor: currentThemeColors.background,
    color: currentThemeColors.foreground,
  } as React.CSSProperties;

  return (
    <div className="relative flex flex-col h-full w-full font-sans overflow-hidden" style={themeVars}>
